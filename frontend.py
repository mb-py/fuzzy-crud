...
filter_gereserveerde_wagens = AttributeFilter('ingeleverd', False)
filter_verhuurd = CompoundFilter(filter_vrouwelijke_reserveringen, filter_gereserveerde_wagens)
...
class TerminalApp:
    ...
    def _create_menu(self) -> Menu:
        ...
        if self.state.active_scribe == klanten:
            ...
            menu.add_item("Toon Verhuurd Vrouwen", lambda: self._switch_scribe(voertuigen, UIDFilter(uidmacro())))
